...
const formTextSize = width * 0.07;
const inputTextSize = width * 0.05;

const buttonTextSize = width * 0.05;

ServiceTypeFormStyles = StyleSheet.create({
    mainContainer: {
    ...
    form: {
        minHeight: mainContainerHeight*0.35,
        maxHeight: mainContainerHeight*0.35,
        minWidth: formWidth,
        maxWidth: formWidth,
...
export default ServiceTypeFormStyles;