...
ActiveRecord::Schema.define(version: 2022_06_12_180333) do
  ...
  create_table "requests", force: :cascade do |t|
    ...
    t.index ["publicacion_id"], name: "index_requests_on_publicacion_id"
  ...
  create_table "rooms", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "publicacion_id", null: false
    t.index ["publicacion_id"], name: "index_rooms_on_publicacion_id"
  end
  ...
  add_foreign_key "requests", "publicacions"
  add_foreign_key "requests", "users"
  add_foreign_key "resenas", "users"
  add_foreign_key "rooms", "publicacions"
end
